...
namespace Silver {
	...
	std::ostream& operator<<(std::ostream& (*f)(std::ostream&), const glm::vec2 &vec2)
	{
		return f(std::cout << "Vec2(" << vec2.x << ", " << vec2.y << ")");
	}

	std::ostream& operator<<(std::ostream& (*f)(std::ostream&), const glm::vec3 &vec3)
	{
		return f(std::cout << "Vec3(" << vec3.x << ", " << vec3.y << ", " << vec3.z << ")");
	}

	std::ostream& operator<<(std::ostream& (*f)(std::ostream&), const glm::vec4 &vec4)
	{
